...
public class SQLiteDatabaseManager
{
	...
	public static final String TWEET_TABLE = "TweetTable";
	public static final String ROW_ID = "_id";
	public static final String TIMESTAMP = "timestamp";
	public static final String TWEET_COLUMN = "tweetColumn";
	...
	{
		String[] requestTableColumnNames = {SQLiteDatabaseManager.TIMESTAMP, SQLiteDatabaseManager.TWEET_COLUMN};
		String[] requestTableColumnDataTypes = {"Text", "Text"};
		createTable(SQLiteDatabaseManager.TWEET_TABLE, requestTableColumnNames, requestTableColumnDataTypes);
